...
train_ocr = pd.read_csv('/content/drive/MyDrive/features/train_ocr_features.csv', index_col=0)
train_cnn = pd.read_csv('/content/drive/MyDrive/features/train_cnn_features.csv', index_col=0)
train_labels = pd.read_csv('/content/drive/MyDrive/preprocessed/train_labels.csv')
