...
# Load test data
test_ocr = pd.read_csv('/content/drive/MyDrive/features/test_ocr_features.csv', index_col=0)
test_cnn = pd.read_csv('/content/drive/MyDrive/features/test_cnn_features.csv', index_col=0)
test_data = pd.concat([test_ocr, test_cnn], axis=1)

# Load the original test file to get entity_name
original_test = pd.read_csv('/content/drive/MyDrive/aml_resource/dataset/test.csv')
